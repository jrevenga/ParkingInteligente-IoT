 ...
 */
@WebServlet("/GetEmptyPlaces")
public class GetEmptyPlaces extends HttpServlet {
	private static final long serialVersionUID = 1L;


    public GetEmptyPlaces() 
    {
        super();
    }
	...
	{
		Log.log.info("-- Get Empty Places from parking--");
		...
		try 
		{
			...
			int value =Logic.getEmptyPlacesFromParking(idCiudad,idParking);
			String jsonPlazas = new Gson().toJson(value);
			Log.log.info("JSON Sensors Values=> {}", jsonPlazas);
